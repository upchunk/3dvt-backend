...
image_directory = 'dataset/Ori/'
mask_directory = 'dataset/Mask/'
...
X_train, X_test, y_train, y_test = train_test_split(
    image_dataset, mask_dataset, test_size=0.10, random_state=0)

# Sanity check, view few mages
image_number = random.randint(0, len(X_train))
plt.figure(figsize=(12, 6))
plt.subplot(121)
plt.imshow(np.reshape(X_train[image_number], (448, 448)), cmap='gray')
plt.subplot(122)
plt.imshow(np.reshape(y_train[image_number], (448, 448)), cmap='gray')
plt.show()
...
model.save('model_tesis_epoch20_sz448.hdf5')
...
model.load_weights('model_tesis_epoch50.hdf5')
...
# =============================================================================
# img1 = test_img_other.squeeze()
# img3 = prediction_other.squeeze()
# img3 = np.ma.masked_where(img3 == 1, img3)
# =============================================================================
...
plt.subplot(236)
plt.title('Prediction Lain')
plt.imshow(img_tes2, cmap='gray', interpolation='none')
plt.imshow(img3, cmap='jet', interpolation='none', alpha=0.7)
plt.show()
